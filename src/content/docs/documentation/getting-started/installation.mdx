...
<Steps>
1. Install [↗ GraalVM](https://www.graalvm.org) and [↗ Maven](https://maven.apache.org)
2. Clone the project:
    ```bash
...
- [Set up transactional emails with SMTP →](/documentation/managing-scoold/emails-and-smtp/)
- [Configure authentication →](/documentation/authentication/basic-auth/)
