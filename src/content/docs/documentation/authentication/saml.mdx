...
```
SAML users with attribute `roles: "administrator"` will become admins in Scoold, after they log in.
...
To allow Scoold to automatically pick up and assing spaces from SAML attributes, enable attribute data delegation from Para to Scoold.
